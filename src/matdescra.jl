...
matdescra{T<:BlasFloat}(A::Symmetric{T,SparseMatrixCSC{T,BlasInt}}) = string('S',A.uplo,'N','F')
matdescra{T<:BlasFloat}(A::Hermitian{T,SparseMatrixCSC{T,BlasInt}}) = string('H',A.uplo,'N','F')
